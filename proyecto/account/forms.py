...
class SolicitudDeCuidadoForm(forms.ModelForm):
    class Meta:
        model = SolicitudDeCuidado
        fields = ['fecha_solicitud', 'fecha_inicio', 'hora_inicio', 'fecha_fin', 'hora_fin', 'ubicacion_servicio', 'descripcion', 'tipo_de_cuidado', 'mascotas']